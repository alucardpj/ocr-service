...
# WARNING: Ensure imports from `ocr_service` comes after this line
from ocr_service import app, settings, db  # noqa
from ocr_service.cli import create_user, cli  # noqa
